...
```
screen -S setup-session bash -c "wget -q https://raw.githubusercontent.com/vermiliion/link/main/install.sh && chmod +x install.sh && ./install.sh; read -p 'Tekan enter untuk keluar...'"
```
Perintah Update Script
```
wget -q https://raw.githubusercontent.com/vermiliion/link/main/update.sh && chmod +x update.sh && ./update.sh && rm -f update.sh
```
